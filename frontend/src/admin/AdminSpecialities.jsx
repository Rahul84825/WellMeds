          ...
          <div className="absolute inset-y-0 right-0 max-w-full flex pl-10">
            <div className="w-screen max-w-2xl bg-white dark:bg-zinc-900 shadow-2xl flex flex-col h-full animate-in slide-in-from-right duration-350">
              ...
              <form onSubmit={handleSave} className="flex-1 overflow-y-auto p-lg space-y-lg text-xs">
                ...
                <div className="space-y-md">
                  <h3 className="font-bold text-[11px] text-slate-400 uppercase tracking-wider pb-xs border-b border-slate-100 dark:border-zinc-800">
                    Clinical Media Assets
                  </h3>

                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-lg">
                    {/* Icon upload */}
                    <div className="space-y-xs">
                      <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">Speciality Icon (Transparent PNG preferred)</label>
                      
                      <div className="mt-1 flex items-center gap-md">
                        {iconImage ? (
                          <div className="relative w-16 h-16 bg-slate-50 dark:bg-zinc-950 border border-slate-200 rounded-xl overflow-hidden flex items-center justify-center p-2 shrink-0">
                            <img src={iconImage} className="w-full h-full object-contain" alt="Icon Preview" />
                            <button
                              type="button"
                          ...
                          <div className="w-16 h-16 bg-[#004782]/5 border border-dashed border-[#004782]/30 rounded-xl flex items-center justify-center shrink-0">
                            <Layers className="text-[#004782]/30" size={20} />
                          </div>
                        )}

                        <div className="flex-1">
                          <label className="relative cursor-pointer bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-xl px-md py-sm flex items-center justify-center font-bold text-[10px] hover:bg-slate-50 dark:hover:bg-zinc-800 transition-all select-none">
                            <Upload className="mr-xs text-slate-400" size={12} />
                    ...
                    {/* Banner upload */}
                    <div className="space-y-xs">
                      <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider">Storefront Hero Banner Image</label>
                      
                      <div className="mt-1 flex items-center gap-md">
                        {bannerImage ? (
                          <div className="relative w-28 h-16 bg-slate-50 dark:bg-zinc-950 border border-slate-200 rounded-xl overflow-hidden shrink-0">
                            <img src={bannerImage} className="w-full h-full object-cover" alt="Banner Preview" />
                            <button
                              type="button"
                          ...
                          <div className="w-28 h-16 bg-[#004782]/5 border border-dashed border-[#004782]/30 rounded-xl flex items-center justify-center shrink-0">
                            <Layers className="text-[#004782]/30" size={24} />
                          </div>
                        )}
