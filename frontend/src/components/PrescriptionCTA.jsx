    ...
    <section className="py-xxl bg-surface transition-colors duration-300">
      <div className="max-w-max-width mx-auto px-margin-desktop">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-xl items-center">
          ...
          {/* Left Column: How It Works Timeline (60% equivalent) */}
          <div className="lg:col-span-7 space-y-lg text-left animate-[fade-in_0.5s_ease-out]">
            <div className="space-y-sm">
              <span className="inline-block bg-[#086b53]/10 dark:bg-[#086b53]/20 text-[#086b53] dark:text-[#84d6b9] text-label-sm px-sm py-[4px] rounded-full font-bold uppercase tracking-wider">
                How It Works
              </span>
              <h2 className="font-headline-md text-headline-md text-on-surface lg:text-headline-lg lg:font-headline-lg">
                Get Your Medicines in 3 Simple Steps
              </h2>
              <p className="font-body-md text-on-surface-variant dark:text-surface-variant max-w-xl">
              ...
              {steps.map((step) => {
                ...
                return (
                  <div key={step.number} className="relative group">
                    ...
                    <div className="pl-sm">
                      <h4 className="font-headline-sm text-headline-sm text-on-surface mb-xs flex items-center gap-sm">
                      ...
                      <p className="font-body-sm text-on-surface-variant dark:text-surface-variant leading-relaxed max-w-lg">
                        {step.description}
                      </p>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-5 h-full flex flex-col justify-center">
            <div className="bg-surface-container-lowest dark:bg-inverse-surface border border-outline-variant/40 dark:border-outline/20 p-lg md:p-xl rounded-2xl shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group relative overflow-hidden flex flex-col items-center justify-center text-center">
              ...
              {/* Upload Icon Badge */}
              <div className="w-16 h-16 bg-[#004782]/10 dark:bg-[#004782]/20 text-[#004782] dark:text-[#a4c9ff] rounded-full flex items-center justify-center mb-lg shadow-inner group-hover:scale-105 transition-transform duration-300">
              ...
              <button
                ...
                className="w-full bg-[#004782] hover:bg-[#003866] text-white py-sm px-lg rounded-xl font-label-md text-label-md font-bold shadow-md hover:shadow-lg transition-all duration-200 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-[#004782] focus:ring-offset-2 flex items-center justify-center gap-xs cursor-pointer select-none"
              >
