...
const steps = [
  {
    number: "01",
    title: "Doctor Rx",
    desc: "Your treating specialist prescribes a therapy covered under a manufacturer PAP.",
    icon: FileText
  },
  {
    number: "02",
    title: "Eligibility Check",
    desc: "Our caseworkers evaluate your clinical and financial details against PAP criteria.",
    icon: Search
  },
  {
    number: "03",
    title: "Document Review",
    desc: "We verify your medical reports, income certificates, and ID proofs for compliance.",
    icon: UserCheck
  },
  {
    number: "04",
    title: "Apply Sourcing",
    desc: "We compile and submit your application docket to the respective pharma brand desk.",
    icon: Send
  },
  {
    number: "05",
    title: "Brand Approval",
    desc: "The manufacturer reviews the docket and issues the subsidized drug approval voucher.",
    icon: ClipboardCheck
  },
  {
    number: "06",
    title: "Safe Delivery",
    desc: "WellMeds dispenses and delivers your approved subsidized medicine under cold-chain.",
    icon: Truck
  }
];
