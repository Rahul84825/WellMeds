...
const programs = [
  {
    name: "Roche Oncology Access Program",
    medicine: "Herceptin (Trastuzumab) / Kadcyla",
    manufacturer: "Roche Products India",
    savings: "Buy 2 Cycles, Get 1 Cycle Free",
    eligibility: "Diagnosed HER2+ breast cancer patients under specialist prescription."
  },
  {
    name: "AstraZeneca Tagrisso Support",
    medicine: "Tagrisso (Osimertinib)",
    manufacturer: "AstraZeneca India",
    savings: "Up to 45% Financial Subsidy",
    eligibility: "EGFR mutation-positive NSCLC patients with income verification."
  },
  {
    name: "Novartis transplant Assistance",
    medicine: "Myfortic (Mycophenolate) / Sandimmun",
    manufacturer: "Novartis India",
    savings: "Subsidized Monthly Maintenance",
    eligibility: "Post-transplant patients undergoing active immunosuppression."
  },
  {
    name: "Pfizer Ibrance Co-Pay Program",
    medicine: "Ibrance (Palbociclib)",
    manufacturer: "Pfizer India",
    savings: "Co-pay support of up to 50%",
    eligibility: "HR+/HER2- metastatic breast cancer patients."
  }
];
            ...
            >
              ...
              <div className="pt-md mt-md border-t border-slate-100 dark:border-zinc-800/60 flex justify-end">
                <button
                  ...
                  className="px-lg h-9 bg-[#086b53] hover:bg-[#065340] text-white rounded-lg text-xs font-bold flex items-center gap-xs transition-all active:scale-95 cursor-pointer"
                >
                  Apply to Program
                  <ArrowRight size={14} />
                </button>
