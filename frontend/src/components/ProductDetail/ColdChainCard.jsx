  ...
  return (
    <div className="bg-sky-500/[0.03] border border-sky-500/10 rounded-2xl p-md space-y-xs text-left select-none">
      <div className="flex items-center gap-sm">
        <span className="material-symbols-outlined text-sky-600 text-[24px] leading-none shrink-0 animate-pulse">ac_unit</span>
        <h4 className="font-extrabold text-[15px] text-sky-750 dark:text-sky-400 uppercase tracking-wider">Temperature Controlled Storage</h4>
      </div>
