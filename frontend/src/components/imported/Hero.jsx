...
const Hero = ({ heroData, onBrowseClick, onRequestClick }) => {
  const data = heroData || {
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#004782]/10 via-[#038076]/5 to-transparent py-20 px-6 sm:px-12 lg:px-24 text-left">
      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-6 z-10">
          ...
          <p className="text-sm sm:text-base text-slate-600 dark:text-zinc-300 leading-relaxed max-w-2xl font-medium font-sans">
            {data.description}
          </p>
        ...
        {/* Right Column - Premium Image or SVG Illustration */}
        <div className="lg:col-span-5 flex justify-center z-10 select-none">
          <div className="relative w-full max-w-[420px] aspect-square flex items-center justify-center">
            {data.imageUrl ? (
              <img 
                src={data.imageUrl} 
                alt="Global Medicine Access" 
                className="w-full h-full object-cover rounded-3xl border border-slate-200 dark:border-zinc-800/80 shadow-2xl" 
              />
            ) : (
